...
const backgrounds = {
  bg1: basicColors.darkBlue1,
  bg2: basicColors.darkBlue2,
  bg3: basicColors.darkBlue3,
  dashboardBg: 'url("/public/img/bg_blue.jpg")',
  bgBlue1: basicColors.blue80,
  bgBlue2: basicColors.blue77,
};

const borders = {
  border1: basicColors.cyan1,
...
const textColors = {
  ...
  textSemiWeak: basicColors.gray90,
  textWeak: basicColors.gray90,
...
const form = {
  ...
  formInputBg: '#2865a5',
  formInputBgDisabled: '#127fde',
  formInputBorder: borders.border1,
